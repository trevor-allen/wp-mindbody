							...
							<div class="inside">
								...
								<form name="mz_mindbody_form" action="" method="post">
									...
									<p><strong><label for='mz_source_name'><?php esc_attr_e('Sourcename: '); ?></label></strong><br>
										...
										if (isset($mz_source_name) && $mz_source_name != '') {
										    echo $mz_source_name;
										} ?>' /></p>

										<p><strong><label for='mz_mindbody_password'><?php esc_attr_e('Key: '); ?></label></strong><br>
											<input id='mz_mindbody_password' name='mz_mindbody_password' class="regular-text" type='text' value='<?php if (isset($mz_mindbody_password) && $mz_mindbody_password != '') {
										    echo $mz_mindbody_password;
										} ?>' /></p>

											<p><strong><label for='mz_mindbody_siteID'><?php esc_attr_e('Site ID: '); ?></label></strong><br>
											<input id='mz_mindbody_siteID' name='mz_mindbody_siteID' class="regular-text" type='text' value='<?php if (isset($mz_mindbody_siteID) && $mz_mindbody_siteID != '') {
										    echo $mz_mindbody_siteID;
										} ?>' /></p>

											<p><strong><label for='mz_mindbody_eventID'><?php esc_attr_e('Event IDs: '); ?></label></strong><br>
											<input id='mz_mindbody_eventID' name='mz_mindbody_eventID' class="regular-text" type='text' value='<?php if (isset($mz_mindbody_eventID) && $mz_mindbody_eventID != '') {
										    echo $mz_mindbody_eventID;
										} ?>' /><span class="description"><?php esc_attr_e(' eg: 25, 17'); ?></span></p>
												<hr/>
												<p>Optional account credentials</p>
											<p><strong><label for='username'><?php esc_attr_e('Username: '); ?></label></strong><br>
											<input id='MBO-username' name='MBO-username' class="regular-text" type='text' value='<?php if (isset($MBO_username) && $MBO_username != '') {
										    echo $MBO_username;
										} ?>' /><span class="description"><?php esc_attr_e('The account name for MBO'); ?></span></p>

											<p><strong><label for='MBO-password'><?php esc_attr_e('Password: '); ?></label></strong><br>
											<input id='MBO-password' name='MBO-password' class="regular-text" type='password' value='<?php if (isset($MBO_password) && $MBO_password != '') {
										    echo $MBO_password;
										} ?>' /><span class="description"><?php esc_attr_e('THe account password for MBO'); ?></span></p>
